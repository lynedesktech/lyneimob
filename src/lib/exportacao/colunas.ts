...
export const colunasImoveis: ColunaExportacao[] = [
  ...
  { campo: "preco_venda", label: "Preço Venda", formatar: (v) => formatarPreco(v as number | null) },
  { campo: "preco_aluguel", label: "Preço Aluguel", formatar: (v) => formatarPreco(v as number | null) },
...
export const colunasAtividades: ColunaExportacao[] = [
  ...
  { campo: "data_inicio", label: "Data Início", formatar: (v) => formatarDataHora(v as string | null) },
