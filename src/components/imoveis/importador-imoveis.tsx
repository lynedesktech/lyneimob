...
import type { ResultadoValidacao, ResultadoImportacao, LinhaImportacao } from "@/types/importacao"
...
function mapearCabecalhos(cabecalhos: string[]): Record<number, string> {
...
function validarLinhas(dados: Record<string, string>[]): ResultadoValidacao[] {
