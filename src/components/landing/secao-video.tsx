      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="mx-auto max-w-2xl text-center">
          ...
          <p className="mt-4 text-lg text-muted-foreground">
            Descubra como a gestão com IA pode transformar a forma como você vende
            imóveis.
          </p>
        </div>
        ...
        <div className="mx-auto mt-12 max-w-4xl">
          <div className="group relative overflow-hidden rounded-2xl border border-border bg-gradient-to-br from-grad-start to-grad-end shadow-2xl shadow-grad-mid/20">
            <div className="aspect-video flex items-center justify-center">
              {/* Padrão decorativo */}
              <div className="absolute inset-0 opacity-[0.05]">
                <div className="absolute top-1/4 left-1/4 h-48 w-48 rounded-full bg-white blur-3xl" />
                <div className="absolute right-1/4 bottom-1/4 h-64 w-64 rounded-full bg-accent-blue blur-3xl" />
              </div>
              ...
              <div className="relative flex flex-col items-center gap-4">
                <div className="flex h-20 w-20 items-center justify-center rounded-full bg-white/15 backdrop-blur-sm transition-all duration-300 group-hover:scale-110 group-hover:bg-white/20">
                  <div className="flex h-14 w-14 items-center justify-center rounded-full bg-white shadow-lg">
                    <Play className="h-6 w-6 text-grad-mid ml-0.5" />
                  </div>
                </div>
