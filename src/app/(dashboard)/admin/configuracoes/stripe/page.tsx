...
export default async function AdminConfiguracoesStripePage() {
  ...
  if (!usuario || !ehSuperAdmin(usuario)) redirect("/configuracoes")
      ...
      <div className="flex items-center gap-4">
        ...
        <div>
          ...
          <p className="text-sm text-muted-foreground">
            Cobrança recorrente, checkout e portal do cliente
          </p>
        </div>
      </div>
